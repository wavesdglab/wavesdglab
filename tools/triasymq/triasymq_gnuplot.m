...
%  Input:
%
%    real VERT1(2), VERT2(2), VERT3(2), the vertices
%    of the triangle.
%
%    real NUMNODES, the number of nodes.
%
%    real RNODES(2,NUMNODES), the coordinates of
%    the nodes.
%
%    string HEADER, a string to be used to identify the files created.
%
