...
%  Input:
%
%    integer ITYPE, the configuration of the quadrature nodes.
...
%
%    integer MMAX, the degree of the quadrature (the maximum degree of
%    the polynomials of two variables that are integrated
%    exactly. 1 <= MMAX <= 50.
%
%  Output:
%
%    real ZS(2,NUMNODES), the nodes.
%
%    real WHTS(NUMNODES), the weights.
%
%    integer NUMNODES, the number of nodes in the quadrature rule.
%
  if ( mmax < 1 | 50 < mmax )
    fprintf ( 1, '\n' );
