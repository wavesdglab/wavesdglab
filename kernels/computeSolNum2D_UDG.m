...
for tri=1:mesh.numTri
    ...
    for fac = 1:3
        ...
        rhsPel = matMel\shapeOrQ' * weightsLinQ * solQ * Jdxdu;
        rhsUel = matMel\shapeOrQ' * weightsLinQ * solDxQ * Jdxdu / (1i*k);
        rhsVel = matMel\shapeOrQ' * weightsLinQ * solDyQ * Jdxdu / (1i*k);
