...
[solRef, matA, rhsA]     = computeSolNum2D_HDG1(mesh, dofm, tau);
...
% subplot(1,3,1);
% hold off
% postProVizuDG(mesh,real(solRef), 'Exact solution');
% subplot(1,3,2);
% hold off
% postProVizuDG(mesh,real(solA), 'Numerical solution');
% subplot(1,3,3);
% hold off
% postProVizuDG(mesh,real(solA-solRef), 'Error');
