...
degree = 3; h = 0.065; omega = 36;         % Case (1)
% degree = 3; h = 0.055; omega = 36.14;      % Case (2)
...
hold on
semilogy(iterVec,error0B,'-xg','DisplayName','CHDG (upwind/Sym-0) - Richardson');
semilogy(iterVec,error1B,'-oc','MarkerFaceColor','c','DisplayName','CHDG (upwind/Sym-0) - CGNR');
semilogy(iterVec,error3B,'-oc','MarkerFaceColor','w','DisplayName','CHDG (upwind/Sym-0) - GMRES');
