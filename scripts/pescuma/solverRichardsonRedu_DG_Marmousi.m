...
function [resRedVec, resPhyVec, errorVec, i, flag, xPhy] = solverRichardsonRedu_DG_Marmousi(mesh, dofm, sys, sol, tol, iMax, iOut, alpha, computeError)
...
while(i <= iMax)
    ...
    if(mod(i,iOut)==0)
        ...
        errorVec(i/iOut+1) = computeError(mesh, dofm, xPhy, sol);
