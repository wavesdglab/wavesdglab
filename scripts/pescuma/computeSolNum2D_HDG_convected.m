...
for tri=1:mesh.numTri
    ...
    matIIel = [
        -1i*k/eta*matMel-1/(rho*c^2)*matDXel*v0(1)-1/(rho*c^2)*matDYel*v0(2)   -matDXel                                             -matDYel                         ;
        -matDXel                                                               -1i*k*eta*matMel-rho*(matDXel*v0(1)+matDYel*v0(2))   zeros(numDofPerTRI,numDofPerTRI) ;
    ...
    for fac = 1:3
        ...
        if (triNeigh > 0)
            ...
            matGIel = - eta / 2 * [1/eta * matM_GIel, nx*matM_GIel, ny*matM_GIel];
