...
function [resVec, errorVec, i_array, flag_array, err_array,X,hrvArray,rvArray,distArrayHRV,distArrayRV] = solverGMRES_RP(mesh, dofm, sys, tol_array, iMax, iOut, computeError)
...
%%%%%% Initialisation
smallEig = 3;
hrvArray = zeros(iMax/iOut+1, smallEig);
rvArray = zeros(iMax/iOut+1, smallEig);
