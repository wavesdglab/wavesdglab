...
% Global matrices
matBi = zeros(dofm.numDofPerLIN, dofm.numDofPerLIN);
matBj = zeros(dofm.numDofPerLIN, dofm.numDofPerLIN);
matBv = zeros(dofm.numDofPerLIN, dofm.numDofPerLIN);
id = 1:dofm.numDofPerLIN;
...
for tri=1:mesh.numTri
    ...
    for fac = 1:3
        ...
        %%%
        idIntP = idIntP'*ones(1,size(idIntP,2));
        idIntU = idIntU'*ones(1,size(idIntP,2));
        idIntV = idIntV'*ones(1,size(idIntP,2));
        %%%
        ...
        if (triNeigh > 0)
            ...
            %%%
            idExtP = idExtP'*ones(1,size(idIntP,2));
            idExtU = idExtU'*ones(1,size(idIntP,2));
            idExtV = idExtV'*ones(1,size(idIntP,2));
            
            matBi(id,:) = idIntP; matBj(id,:) = idIntP'; matBv(id,:) = + 0.5*tau*theta         * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntP; matBj(id,:) = idIntU'; matBv(id,:) = + 0.5*nx                * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntP; matBj(id,:) = idIntV'; matBv(id,:) = + 0.5*ny                * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntP; matBj(id,:) = idExtP'; matBv(id,:) = - 0.5*tau*theta         * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntP; matBj(id,:) = idExtU'; matBv(id,:) = + 0.5*nx                * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntP; matBj(id,:) = idExtV'; matBv(id,:) = + 0.5*ny                * matMel; id = id+dofm.numDofPerLIN;
            
            matBi(id,:) = idIntU; matBj(id,:) = idIntP'; matBv(id,:) = + 0.5*nx                * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntU; matBj(id,:) = idIntU'; matBv(id,:) = + 0.5/tau*theta * nx*nx * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntU; matBj(id,:) = idIntV'; matBv(id,:) = + 0.5/tau*theta * nx*ny * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntU; matBj(id,:) = idExtP'; matBv(id,:) = + 0.5*nx                * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntU; matBj(id,:) = idExtU'; matBv(id,:) = - 0.5/tau*theta * nx*nx * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntU; matBj(id,:) = idExtV'; matBv(id,:) = - 0.5/tau*theta * nx*ny * matMel; id = id+dofm.numDofPerLIN;
            
            matBi(id,:) = idIntV; matBj(id,:) = idIntP'; matBv(id,:) = + 0.5*ny                * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntV; matBj(id,:) = idIntU'; matBv(id,:) = + 0.5/tau*theta * nx*ny * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntV; matBj(id,:) = idIntV'; matBv(id,:) = + 0.5/tau*theta * ny*ny * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntV; matBj(id,:) = idExtP'; matBv(id,:) = + 0.5*ny                * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntV; matBj(id,:) = idExtU'; matBv(id,:) = - 0.5/tau*theta * nx*ny * matMel; id = id+dofm.numDofPerLIN;
            matBi(id,:) = idIntV; matBj(id,:) = idExtV'; matBv(id,:) = - 0.5/tau*theta * ny*ny * matMel; id = id+dofm.numDofPerLIN;
            %%%
...
%             matA(idIntV,idExtV) = matA(idIntV,idExtV) - 0.5/tau*theta * ny*ny * matMel;
            ...
            switch tagToBC(mesh.tagEdg(edgGlo))
                case 'DIR'
                    ...
                    %%%
                    matBi(id,:) = idIntP; matBj(id,:) = idIntP'; matBv(id,:) = + tau*theta * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntP; matBj(id,:) = idIntU'; matBv(id,:) = + nx        * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntP; matBj(id,:) = idIntV'; matBv(id,:) = + ny        * matMel; id = id+dofm.numDofPerLIN;
                    %%%
...
%                     matA(idIntP,idIntV) = matA(idIntP,idIntV) + ny        * matMel;
                ...
                case 'NEU'
                    ...
                    %%%
                    matBi(id,:) = idIntU; matBj(id,:) = idIntP'; matBv(id,:) = + 1            * nx * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntU; matBj(id,:) = idIntU'; matBv(id,:) = + nx/tau*theta * nx * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntU; matBj(id,:) = idIntV'; matBv(id,:) = + ny/tau*theta * nx * matMel; id = id+dofm.numDofPerLIN;
                    
                    matBi(id,:) = idIntV; matBj(id,:) = idIntP'; matBv(id,:) = + 1            * ny * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntV; matBj(id,:) = idIntU'; matBv(id,:) = + nx/tau*theta * ny * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntV; matBj(id,:) = idIntV'; matBv(id,:) = + ny/tau*theta * ny * matMel; id = id+dofm.numDofPerLIN;
                    %%%
...
%                     matA(idIntV,idIntV) = matA(idIntV,idIntV) + ny/tau*theta * ny * matMel;
                ...
                case 'ABC'
                    ...
                    %%%
                    matBi(id,:) = idIntP; matBj(id,:) = idIntP'; matBv(id,:) = + tau/(1+tau)         * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntP; matBj(id,:) = idIntU'; matBv(id,:) = + 1/(1+tau) * nx      * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntP; matBj(id,:) = idIntV'; matBv(id,:) = + 1/(1+tau) * ny      * matMel; id = id+dofm.numDofPerLIN;
                    
                    matBi(id,:) = idIntU; matBj(id,:) = idIntP'; matBv(id,:) = + tau/(1+tau)    * nx * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntU; matBj(id,:) = idIntU'; matBv(id,:) = + 1/(1+tau) * nx * nx * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntU; matBj(id,:) = idIntV'; matBv(id,:) = + 1/(1+tau) * ny * nx * matMel; id = id+dofm.numDofPerLIN;
                    
                    matBi(id,:) = idIntV; matBj(id,:) = idIntP'; matBv(id,:) = + tau/(1+tau)    * ny * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntV; matBj(id,:) = idIntU'; matBv(id,:) = + 1/(1+tau) * nx * ny * matMel; id = id+dofm.numDofPerLIN;
                    matBi(id,:) = idIntV; matBj(id,:) = idIntV'; matBv(id,:) = + 1/(1+tau) * ny * ny * matMel; id = id+dofm.numDofPerLIN;
                    %%%
...
matB = sparse(matBi,matBj,matBv,3*numDofTRI,3*numDofTRI);
matA = matA + matB;
