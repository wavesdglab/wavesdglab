...
folder = "output/defMesh_scatt";
if ~exist(folder, 'dir')
    mkdir(folder);
end


csvwrite([folder+"/nbitGMRES.csv"], nbitGMRES);
csvwrite([folder+"/nbitADAnalyProj.csv"], nbitADAnalyProj');
csvwrite([folder+"/nbitADNum.csv"], nbitADNum');

csvwrite([folder+"/resvecGMRES.csv"], resvecGMRES);
csvwrite([folder+"/resvecADAnalyProj.csv"], resvecADAnalyProj);
csvwrite([folder+"/resvecADNum.csv"], resvecADNum);
