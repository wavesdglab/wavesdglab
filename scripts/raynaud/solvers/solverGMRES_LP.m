...
function [resVec, errorVec, i_array, flag_array, err_array,X,hrvArray,rvArray,distArrayHRV,distArrayRV] = solverGMRES_LP(mesh, dofm, sys, tol_array, iMax, iOut, computeError)
