...
function [solI, sysA] = computeSolNum2D_CHDG_2nd_order(mesh, dofm, tau, ~, PREC)
...
sysA.matGI = matGF * (matFF \ (matFH * (matHH \ matHI))) - matGH * (matHH \ matHI);
sysA.matGG = matGG - matGF * (matFF \ matFG);
