...
function [resRedVec, resPhyVec, errorVec, i, flag, xPhy] = solverGMRESredu_DG_precLeft(mesh, dofm, sys, tol, iRestart, iMax, iOut, computeError, xRef)
...
%%%%%%%
xPhy = sys.matIIinv*(sys.rhsI-sys.matIG*x0);
