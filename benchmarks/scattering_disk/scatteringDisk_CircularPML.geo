...
// Domain
Curve Loop(1) = {1, 2, 3, 4, -11, -12, -13, -14};
Plane Surface(1) = {1};

// Layer
Curve Loop(2) = {11, 12, 13, 14, -21, -22, -23, -24};
Plane Surface(2) = {2};

// Definition of the physical regions
Physical Curve(201) = {1, 2, 3, 4};     // Boundary of scattering disk
Physical Curve(202) = {21, 22, 23, 24}; // Exterior boundary of the layer
