...
switch PML_TYPE
    case 'Rectangular'
        ...
        linkGeo = append(fileparts(mfilename('fullpath')),'/scatteringDisk_RectangularPML.geo');
    ...
    case 'Circular'
        ...
        linkMsh = 'output/mesh.msh';
        linkGeo = append(fileparts(mfilename('fullpath')),'/scatteringDisk_CircularPML.geo');
        system(['gmsh -2 ' linkGeo ' -o ' linkMsh ' -clmax ' num2str(h) ' -clmin ' num2str(h) ...
            ' -setnumber Rdisk ' num2str(Rdisk) ...
